from trade_agents.agents.tool_caller.utils import function_to_json
...
from trade_agents.inference.utils import msg_dict_to_oai, msg_dict_to_anthropic, parse_json_string
