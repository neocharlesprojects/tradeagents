...
from trade_agents.environments.mechanisms.auction import DoubleAuction
from trade_agents.orchestrator import Orchestrator, OrchestratorConfig, AgentConfig, AuctionConfig, LLMConfig
from trade_agents.agents.market_agent import MarketAgent
from trade_agents.environments.environment import MultiAgentEnvironment
from trade_agents.agents.protocols.acl_message import ACLMessage
from trade_agents.simulation_app import create_dashboard
...
class TestOrchestrator(unittest.TestCase):
    ...
    @patch('trade_agents.agents.market_agent.MarketAgent')
    ...
    @patch('trade_agents.environments.environment.MultiAgentEnvironment')
    @patch('trade_agents.environments.mechanisms.auction.DoubleAuction')
    ...
    @patch('trade_agents.simulation_app.create_dashboard')
