...
from trade_agents.agents.personas.persona import generate_persona, save_persona_to_file, Persona

class TestPersona(unittest.TestCase):
    @patch('trade_agents.agents.personas.persona.random.choice')
    @patch('trade_agents.agents.personas.persona.random.randint')
    @patch('trade_agents.agents.personas.persona.names.get_full_name')
    @patch('trade_agents.agents.personas.persona.random.random')
    ...
    @patch('trade_agents.agents.personas.persona.yaml.dump')
    def test_save_persona_to_file(self, mock_yaml_dump):
        ...
        with patch('trade_agents.agents.personas.persona.open', mock_open()) as mock_file:
